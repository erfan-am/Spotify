...
const Mian = ({ group,setLikes,likes,getFetchDataSongs,getGroupSearch}) => {
    ...
    return (
        <div className="main">
            ...
            <Switch>
                ...
                <Route path="/:yourname/fileplaylist/:fleName"
                component={YourPlayList} />
                <Route path="/playlist/:itemId" render={(() =>
                    <PlayList setLikes={setLikes} group={group} />)} />
            </Switch>
        </div>
    );
};
