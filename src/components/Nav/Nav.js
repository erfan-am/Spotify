...
import  './Nav.scss';
import {createFile,removeFile,getChooseFile} from '../../store/createt_file/function'
...
const Nav = ({createFile,files,removeFile,getChooseFile}) => {
    ...
    return (
        <Flex dir="column" width="280px" className="navBar">
            <div className="logo">
               <svg viewBox="0 0 73 17" width="200" fill="white" preserveAspectRatio="xMidYMin meet"><g fill-rule="evenodd">
                    ...
                    <li >
                        <svg viewBox="0 0 512 512"
                            ...
                            <path d="M448 463.746h-149.333v-149.333h-85.334v149.333h-149.333v-315.428l192-111.746 192 110.984v316.19z"
                                fill="currentColor" /></svg>Home</li>
                </NavLink>
                <NavLink to="/search" exact>
                    <li><svg viewBox="0 0 512 512" width="24" height="24" xmlns="http://www.w3.org/2000/svg"><path d="M349.714 347.937l93.714 109.969-16.254 13.969-93.969-109.969q-48.508 36.825-109.207 36.825-36.826 0-70.476-14.349t-57.905-38.603-38.603-57.905-14.349-70.476 14.349-70.476 38.603-57.905 57.905-38.603 70.476-14.349 70.476 14.349 57.905 38.603 38.603 57.905 14.349 70.476q0 37.841-14.73 71.619t-40.889 58.921zM224 377.397q43.428 0 80.254-21.461t58.286-58.286 21.461-80.254-21.461-80.254-58.286-58.285-80.254-21.46-80.254 21.46-58.285 58.285-21.46 80.254 21.46 80.254 58.285 58.286 80.254 21.461z" fill="currentColor" fillRule="evenodd" /></svg>Search</li>
                </NavLink>
                <NavLink to="/" exact>
                    <li><svg viewBox="0 0 512 512" width="24" height="24" xmlns="http://www.w3.org/2000/svg"><path d="M291.301 81.778l166.349 373.587-19.301 8.635-166.349-373.587zM64 463.746v-384h21.334v384h-21.334zM192 463.746v-384h21.334v384h-21.334z" fill="currentColor" /></svg>Your Library</li>
                </NavLink>
            </ul>
            <Flex dir="column" justify="center" className="create_list">
                <li onClick={()=>setShoForm(true)} className="create_list_span">
                <svg  className="c0c4eafc5a90133e275bc12802a9c836-scss" shape-rendering="crispEdges" viewBox="0 0 36 36"><path d="m28 20h-8v8h-4v-8h-8v-4h8v-8h4v8h8v4z"></path></svg>
                <p>Create Playlist</p>
                 </li>
                 {showForm ? 
                     <form onSubmit={createFileHandler} className="craeteFile">
                         ...
                         />
                         <div className="button_group_for_create_file">
                             <Button color="white" onClick={createFileHandler}
                         type="button">Create</Button>
                         <Button bg="red" color="white" onClick={showFormCansel} type="button">Cancel</Button>
                         </div>
                     </form>: null
                 }
                {files.length > 0 ?
                 <div className="scroll_playList">
                  {files.map(file=>(
                         <Flex  dir="row" justify="space-around" key={file.id} className="create_list_span">
                 ...
                 <Link to="/likes">  <li className="create_list_span">
                
                    <svg  xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" viewBox="0 0 24 24" className="likeIcon">
...
export default connect(mapStateToProps,{createFile,removeFile,getChooseFile})(Nav);
