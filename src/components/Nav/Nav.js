    ...
    <Flex dir="column" width="280px" className="navBar">
      ...
      <Flex dir="column" justify="center" className="create_list">
        <li onClick={() => setShoForm(true)} className="create_list_span">
          <svg
            className="c0c4eafc5a90133e275bc12802a9c836-scss"
        ...
        {showForm ? (
          ...
          >
            ...
            <div className="button_group_for_create_file">
              <Button color="white" onClick={createFileHandler} type="button">
                Create
              </Button>
              <Button
                bg="red"
                color="white"
                onClick={showFormCansel}
                type="button"
              >
                Cancel
              </Button>
        ...
        <Link to="/likes">
          ...
          <li className="create_list_span">
            ...
            >
              <path
                d="M20.4852814,13.2426407 L12,21.7279221 L3.51471863,13.2426407 C1.17157288,10.8994949 1.17157288,7.10050506 3.51471863,4.75735931 C5.85786438,2.41421356 9.65685425,2.41421356 12,4.75735931 C14.3431458,2.41421356 18.1421356,2.41421356 20.4852814,4.75735931 C22.8284271,7.10050506 22.8284271,10.8994949 20.4852814,13.2426407 Z"
                id="path-1"
              ></path>
            </svg>
            <p>Liked Songs</p>
