...
const Musicbar = ({ song, removeSongPlay, create, showFormFile }) => {
  return (
    <Flex dir="row" height="85px" justify="space-between" className="musicsCTR">
      {song && (
        <Flex dir="row" width="300px" justify="center" className="musicBar">
          <span onClick={() => removeSongPlay()} className="remove">
            X
          </span>
...
export default connect(mapStateToProps, { removeSongPlay, showFormFile })(
  Musicbar
);
