        ...
        <Flex dir="column" className="PlayListPage">
            ...
            <Flex dir="row" height="60px" className="icons">
                <div className="playButon">
                    <svg role="img" width="48" viewBox="0 0 24 24" aria-hidden="true"><polygon points="21.57 12 5.98 3 5.98 21 21.57 12" fill="currentColor" /></svg>
                </div>
                <div className="iconHeart" />
                <Flex dir="row" width="50px" align="center" justify="space-around" className="Bots">
                    <span />
                    <span />
                    <span />
                </Flex>
